...
import styles from './styles03';

const mega=({uri :'http://mhs.rey1024.com/1415051014/Image/megaxus.jpg'});
var URL="http://mhs.rey1024.com/1415051014/produk3.php";

class Megaxus extends Component {
    ...
    return (
      <Container style={styles.container}>
        <Header>
          ...
          <Body>
            <Title>{(this.props.name) ? this.props.name : 'Megaxus'}</Title>
          </Body>    
          <Right>
...
export default connect(mapStateToProps, bindAction)(Megaxus);
